...
public class SyslogService extends AbstractLifecycleComponent<SyslogService> {
    ...
    public SyslogService(Settings settings, Client client, NetworkService networkService) {
        ...
        logger.info("syslog server at host [{}], port [{}], bulk_actions [{}], bulk_size [{}], flush_interval [{}], concurrent_requests [{}], index [{}], type [{}]",
                host, port, bulkActions, bulkSize, flushInterval, concurrentRequests, index, type);
    }
